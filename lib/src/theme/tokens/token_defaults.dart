...
// Token values are reproduced verbatim from upstream. Reflowing them would
// change the strings the parity tests compare against.
// ignore_for_file: lines_longer_than_80_chars

/// Astryx's default token values, keyed by CSS custom property name.
///
/// 184 tokens, transcribed verbatim from upstream — values are not
/// normalised, reformatted or pre-parsed. Some are concrete
/// (`'#0064E0'`), some are `light-dark()` pairs, and some are `var()`
/// references that the Phase 2 resolver follows.
const Map<String, String> astryxTokenDefaults = <String, String>{
