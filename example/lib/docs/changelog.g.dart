...
const List<DocBlock> changelogBlocks = <DocBlock>[
  ...
  DocProse('Sixteen new components, and the documentation for them. Two existing widgets changed — both fixes, both in **Fixed**.'),
  ...
  DocHeading('0.0.6-dev'),
  DocProse('Documentation and tooling only. No library code changed, so nothing here can break a consumer.'),
  DocHeading('Added', level: 3),
  DocList(<String>[
  ...
  DocHeading('Known limitations, now documented', level: 3),
  DocProse('Three layout traps found while building the templates, all of them the same root cause — a widget that measures its children intrinsically cannot measure the touch-target wrapper or a `LayoutBuilder` inside them, so they assert in touch density:'),
  DocList(<String>[
  ...
  DocHeading('0.0.5-dev'),
  DocProse('Documentation, tooling and tests only. No library code changed, so nothing here can break a consumer.'),
  DocHeading('Added', level: 3),
  DocList(<String>[
  ...
  DocHeading('0.0.3-dev'),
  DocProse('Documentation only. No library code changed, so nothing here can break a consumer.'),
  DocHeading('Added', level: 3),
  DocList(<String>[
  ...
  DocHeading('0.0.1-dev'),
  DocProse('First development preview. The API is unstable and may change without a major version bump until 0.1.0.'),
  DocHeading('Added', level: 3),
  DocList(<String>[
