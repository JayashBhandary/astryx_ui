...
Something wrong with `Contact form`, or missing from it? [Report a bug](https://github.com/JayashBhandary/astryx_ui/issues/new?template=bug_report.yml&title=%5Bbug%5D+Contact+form&component=Contact+form) · [Request a change](https://github.com/JayashBhandary/astryx_ui/issues/new?template=feature_request.yml&title=%5Bfeature%5D+Contact+form&area=Contact+form) — both templates arrive with the component filled in.
