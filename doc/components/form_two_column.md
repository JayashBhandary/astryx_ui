...
Something wrong with `Two-column form`, or missing from it? [Report a bug](https://github.com/JayashBhandary/astryx_ui/issues/new?template=bug_report.yml&title=%5Bbug%5D+Two-column+form&component=Two-column+form) · [Request a change](https://github.com/JayashBhandary/astryx_ui/issues/new?template=feature_request.yml&title=%5Bfeature%5D+Two-column+form&area=Two-column+form) — both templates arrive with the component filled in.
